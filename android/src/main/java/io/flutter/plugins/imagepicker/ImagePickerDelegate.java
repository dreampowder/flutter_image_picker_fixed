...
public class ImagePickerDelegate
  ...
  private void launchPickImageFromGalleryIntent() {
    ...
    activity.startActivityForResult(Intent.createChooser(pickImageIntent,""), REQUEST_CODE_CHOOSE_IMAGE_FROM_GALLERY);
  }
  ...
  private boolean setPendingMethodCallAndResult(
      ...
      Boolean willOverridePendingResult = methodCall.argument("overridePendingPoverridePendingResult");
      if (willOverridePendingResult == null){
          willOverridePendingResult = false;
      }
    if (pendingResult != null && !willOverridePendingResult) {
      return false;
    }
